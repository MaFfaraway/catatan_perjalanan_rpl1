...
<head>
    ...
    <link rel="stylesheet" href="<?= $url?>btsp/css/bootstrap.min.css">
...
<nav class="sticky-top shadow navbar navbar-expand-lg bg-light">
        <div class="container-fluid container">
            <a class="navbar-brand" href="#">
                <img src="<?= $url ?>img/logoKEMKES.png" alt="">
            </a>
            ...
            <div class="collapse navbar-collapse flex-grow" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto gap-5 flex-nowrap">
                    ...
                    <li class="nav-item mx-2">
                        <a class="nav-link" href="<?= $url ?>admin/lokasi/lokasi.php">Lokasi</a>
                    </li>
                ...
                <button class="btn btn-outline-success" onclick="location.href='<?= $url ?>config/logout.php'">Logout</button>
